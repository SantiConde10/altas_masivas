...
- Solución: Verifica que sea "SantiConde10" / "altas_masivas"

### Error: "Timeout después de 30 segundos"
- GitHub está lento o no hay conexión internet
- Solución: Reintenta en unos segundos

### No muestra actualización disponible
- La versión en GitHub es menor o igual a la actual
- Verifica que el tag en GitHub sea vX.X.X con número mayor
